...
# print(f"Algorithm results: {algorithm.result}") # Removed debug print
...
# print("algorithm.result:", algorithm.result) # Removed debug print
# print("pareto_solutions_formatted:", pareto_solutions_formatted) # Removed debug print
# print("all_solutions_formatted[0:5]:", all_solutions_formatted[0:5]) # Removed debug print (all_solutions_formatted was the old name for all_solutions from final pop)

# print("len(pareto_solutions_platypus_objects):", len(pareto_solutions_platypus_objects)) # Removed debug print
# print("len(all_solutions_formatted):", len(all_solutions_formatted)) # Removed debug print
